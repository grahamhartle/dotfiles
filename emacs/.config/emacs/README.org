...
- [[#set-up-the-customel-file][Set up the 'custom.el' file]]
- [[#set-up-the-basic-defaults-for-emacs][Set up the basic defaults for Emacs]]
- [[#fonts][Fonts]]
- [[#initialising-the-package-management-system][Initialising the package management system]]
- [[#packages][Packages]]
...
- [[#terminal-setup][Terminal setup]]
  - [[#vterm][Vterm]]
  - [[#magit][Magit]]
  - [[#set-up-odin-mode-and-ols-for-programming][Set up Odin-mode and OLS for programming]]
...
** Set up Odin-mode and OLS for programming
#+begin_src emacs-lisp
